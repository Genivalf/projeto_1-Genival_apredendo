...
<body>
    ...
    <?php
        require "../../br.edu.ifsc.controller/dados-conexao.inc.php";
        require "../../br.edu.ifsc.controller/conectar.inc.php";
        require "../../br.edu.ifsc.controller/criar-banco.inc.php";
        require "../../br.edu.ifsc.controller/abrir-banco.inc.php";
        require "../../br.edu.ifsc.controller/definir-utf8.inc.php";
        require "../../br.edu.ifsc.controller/criar-tabela.inc.php";

            if(isset($_POST['cadastrar-usuario'])){
            require "../../br.edu.ifsc.controller/cadastrar-usuario.inc.php";
            }

            if(isset($_POST['pagamentos'])){
            require "../../br.edu.ifsc.controller/pagamentos.inc.php";
            }
            
            if(isset($_POST['contatos'])){
            require "../../br.edu.ifsc.controller/contatos.inc.php";
            }

            if(isset($_POST['excluir-usuario'])){
            require "../../br.edu.ifsc.controller/excluir-usuario.inc.php";
            }

            require "../../br.edu.ifsc.controller/desconectar.inc.php";  
    ?>
